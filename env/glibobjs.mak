...
# C/C++ Compiler Used: MSVC, BCC32, GCC, HPUX aCC, SOLARIS CC
...
eds101$(OBJ_EXT):	$(GLIB_SRC_PATH)eds101.cpp $(EDS101_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
	$(GLIB_SRC_PATH)eds101.cpp

eds201$(OBJ_EXT):	$(GLIB_SRC_PATH)eds201.cpp $(EDS201_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
	$(GLIB_SRC_PATH)eds201.cpp

edscfg$(OBJ_EXT):	$(GLIB_SRC_PATH)edscfg.cpp $(EDSCFG_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
...
sreg101$(OBJ_EXT):	$(GLIB_SRC_PATH)sreg101.cpp $(SREG101_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
