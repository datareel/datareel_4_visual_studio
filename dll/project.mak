...
#######################
# --------------------------------------------------------------- 
# Makefile Contents: Project makefile for the MSVC gxcode dynamic link library
...
/D "GXDLCODE_EXPORTS" \
/Fp"./$(OUTDIR)\$(PROJECT).pch" /YX /Fo"./$(OUTDIR)\\" \
...
$(OUTDIR)\eds101$(OBJ_EXT):	$(GLIB_SRC_PATH)eds101.cpp $(EDS101_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
	$(GLIB_SRC_PATH)eds101.cpp

$(OUTDIR)\eds201$(OBJ_EXT):	$(GLIB_SRC_PATH)eds201.cpp $(EDS201_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
	$(GLIB_SRC_PATH)eds201.cpp

$(OUTDIR)\edscfg$(OBJ_EXT):	$(GLIB_SRC_PATH)edscfg.cpp $(EDSCFG_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
	$(GLIB_SRC_PATH)edscfg.cpp
...
$(OUTDIR)\sreg101$(OBJ_EXT):	$(GLIB_SRC_PATH)sreg101.cpp $(SREG101_DEP)
	$(CPP) $(COMPILE_ONLY) $(COMPILE_FLAGS) \
	$(GLIB_SRC_PATH)sreg101.cpp
...
GLIB_GP_OBJECTS = $(OUTDIR)\asprint$(OBJ_EXT) \
	...
	$(OUTDIR)\eds101$(OBJ_EXT) \
	$(OUTDIR)\eds201$(OBJ_EXT) \
	$(OUTDIR)\edscfg$(OBJ_EXT) \
